...
Scene_Map.prototype.initialize = function() {
    ...
    //
    this.waitReady = 40; // ready stabiliser
};

Scene_Map.prototype.create = function() {
    this.create_map();
   // create Map
   // create setupEvents this._events[i] = new Game_Event(this._mapId, i); , les event seront tres simple
   // crea6te sprite
};

Scene_Map.prototype.create_map = function() {
    const data = $Loader.loaderSet[$player.currentGalaxi][$player.currentPlanet][$player.currentMap];
    const mapData = $Loader._planet._bg[$player.currentMap];

    const cage = new PIXI.Container();
    const sprite_d = new PIXI.Sprite(mapData.texture);
    const sprite_n = new PIXI.Sprite(mapData.texture_n);
    // asign group display
